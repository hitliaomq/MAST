...
from MAST.structopt_stem.generate.surface import get_surface_restart_indiv
from MAST.structopt_stem.generate.defect import get_defect_restart_indiv
from MAST.structopt_stem.generate.crystal import get_crystal_restart_indiv
try:
