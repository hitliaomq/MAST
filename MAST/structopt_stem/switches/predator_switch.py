...
from MAST.structopt_stem.switches import selection_switch
from MAST.structopt_stem.switches import lambdacommamu
...
def predator_switch(pop,Optimizer):
    ...
    STR = 'PREDATOR\n'
    try:
       exec("from MAST.structopt_stem.predator.{0} import {0}".format(scheme))
